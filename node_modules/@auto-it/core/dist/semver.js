...
exports.calculateSemVerBump = exports.getHigherSemverTag = exports.defaultLabels = exports.labelDefinition = exports.isVersionLabel = exports.releaseLabels = exports.preVersionMap = void 0;
...
const getBump = (releaseType) => releaseType === "none" || releaseType === "skip"
    ? SEMVER.noVersion
    : releaseType === "release"
        ? SEMVER.patch
        : releaseType || SEMVER.patch;
