    ...
    apply(auto) {
        ...
        auto.hooks.onCreateChangelog.tap(this.name, (changelog, version = core_1.SEMVER.patch) => {
            changelog.hooks.renderChangelogLine.tapPromise('NPM - Monorepo', async ([commit, line]) => {
                ...
                const section = ((_a = packages) === null || _a === void 0 ? void 0 : _a.length) ? packages.map(p => `\`${p}\``).join(', ')
                    : 'monorepo';
                if (section === 'monorepo') {
                    return [commit, line];
                }
        ...
        auto.hooks.canary.tapPromise(this.name, async (bump, postFix) => {
            ...
            const latestTag = (await ((_a = auto.git) === null || _a === void 0 ? void 0 : _a.getLatestTagInBranch())) || lastRelease;
            ...
            const canaryVersion = core_1.determineNextVersion(lastRelease, current, bump, `canary${postFix}`);
            if (this.canaryScope) {
